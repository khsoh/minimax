...
-- ├── 01_hooks.lua    All Config.on_packchanged declarations live here
-- ├── 02_miniinit.lua Other mini.nvim initialization that used to live in init.lua
...
-- Function to shorten github repo prefix
